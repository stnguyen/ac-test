...
describe("linearScaleSort", () => {
  it("should return an array of predicates sorted by the value at the given key, between a reference and the furthest value", () => {
    // linear scale from 2 to 8
    const reference = 2;
